...
# PyroClient Setup 
API_ID = environ.get('API_ID', '13050924')
API_HASH = environ.get('API_HASH', 'fe442e491c1841a12daeb6754d133739')
BOT_TOKEN = environ.get('BOT_TOKEN', '6140001085:AAGYF67tawQfXinRaBnvK5wzq7U0qGfWpWY')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1598575940').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1598575940').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('1001916624657')
auth_grp = environ.get('1001730850522')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://vasanthakumar200612:Vasanthkumar@200612@autofilterbot.zidghl6.mongodb.net/?retryWrites=true&w=majority&appName=AutoFilterBot")
